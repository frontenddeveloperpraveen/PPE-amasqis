...
const IncidentReport = () => {
  ...
  const [data, setData] = useState({
    recentReports: [
      {
        id: 1,
        name: "Unauthorized Access - Main Gate",
        status: "Under Review",
        timestamp: "2023-05-15 14:30:22",
      },
      {
        id: 2,
        name: "Suspicious Package - Parking Lot",
        status: "Pending",
      ...
      },
      {
        ...
        status: "Resolved",
        timestamp: "2023-05-14 09:45:10",
      },
      {
        id: 4,
        name: "Perimeter Breach - East Fence",
        status: "Critical",
        timestamp: "2023-05-14 03:20:33",
      },
      {
        id: 5,
        name: "Equipment Tampering - Server Room",
        status: "Under Review",
        timestamp: "2023-05-13 18:05:17",
      },
    ],
    incidents: [
      {
      ...
      },
      {
        ...
        location: "East Fence",
        cameraId: "CAM-004",
        event: "Perimeter Breach",
        personnel: "Emma Davis",
        status: "Critical",
      },
      {
        id: 105,
        ...
        cameraId: "CAM-005",
        event: "Equipment Tampering",
        personnel: "Robert Wilson",
        status: "Under Review",
      },
      {
        id: 106,
        timestamp: "2023-05-13 10:30:00",
        location: "Lobby",
        cameraId: "CAM-006",
        event: "Unauthorized Access",
        personnel: "Lisa Taylor",
        status: "Resolved",
      },
      {
        id: 107,
        timestamp: "2023-05-12 22:15:45",
        location: "Loading Dock",
        cameraId: "CAM-007",
        event: "After Hours Activity",
        personnel: "James Miller",
        status: "Pending",
      },
    ],
    statistics: {
      incidentTrends: {
        ...
        categories: [
          ...
          { name: "Perimeter Breach", value: 8 },
          { name: "Suspicious Activity", value: 7 },
          { name: "Fire Alarm", value: 5 },
          { name: "Equipment Tampering", value: 4 },
          { name: "Other", value: 3 },
        ],
      },
      cameraActivity: {
        ...
        change: "-5%",
        locations: [
          { name: "Main Gate", value: 78 },
          { name: "Parking Lot", value: 65 },
          { name: "Building A", value: 58 },
          { name: "East Fence", value: 45 },
          { name: "Server Room", value: 36 },
          { name: "Lobby", value: 30 },
          { name: "Loading Dock", value: 30 },
        ],
      },
    },
    locations: [
